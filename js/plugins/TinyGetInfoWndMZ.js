...
/*:
 * @target MZ
 * @plugindesc [Ver1.0.5]Display one-line window of gaining/losing items information
...
/*:ja
 * @target MZ
 * @plugindesc [Ver1.0.5]アイテムの入手/消失を1行ウィンドウで表示します
...
(() => {
  ...
  Window_GetInfo.prototype.drawContents = function(id, type, text, value) {
    ...
    if(type >= 0 && type <= 2) {
      ...
      this.resetTextColor();
      if (defaultInfoTextType === 'firstLine') {
